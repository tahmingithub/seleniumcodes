...
//        click on the calander
        ...
        while(notfound) {
            ...
            if (currentMonth.equals("December")) {
                List<WebElement> dates = driver.findElements(By.xpath("//table[@class='ui-datepicker-calendar']/tbody/tr/td"));// go through all the date
//                iterate
                ...
                WebElement next = driver.findElement(By.xpath("//a[@data-handler='next']"));// if current month is not equal to december, go to next page
                next.click();
            }
        }
    }
