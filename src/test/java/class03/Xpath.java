...
//        get the email
        ...
        // we have two identical element so we mark as indexes
...
//        get the below fields
        ...
        // we have two element that is the same only the deta detail of first one is one , second one is  two
        // so we concatenate them using (and ).
        Field1.sendKeys("cat");
